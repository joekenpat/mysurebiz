...
class CreateLibraryBusinessCategoriesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('library_business_categories', function (Blueprint $table) {
            $table->engine = 'InnoDB';
    ...
    public function down()
    {
        ...
        Schema::dropIfExists('library_business_categories');
