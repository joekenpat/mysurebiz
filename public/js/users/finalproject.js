...
$('#submitassignment button[type=submit]').click(function (e) {
    ...
    $.ajax({
        url: '/submitfinalproject/'+courseId,
        ...
        success: function (data, textStatus, jqXHR) {
            ...
            <div class="assignment-submitted text-center">
                <div class="d-inline-block p-1 text-color-green"><i class="icon-check"></i> Project Submitted Successfully</div>
            </div>
        ...
        error: function (e) {
            ...
            if(error.errors['project']){
                insertAfterInputError($('.upload-lesson-assignment'), error.errors['project']);
            }
            console.log(error);
        }
    });
